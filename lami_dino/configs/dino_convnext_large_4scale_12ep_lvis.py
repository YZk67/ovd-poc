...
model.novel_logit_scale = 1.35  # reduce over-boost to improve novel precision
model.seen_logit_scale = 0.9  # milder seen suppression
model.freq_reweight = True
model.freq_scale_rare = 1.5
model.freq_scale_common = 1.2
model.freq_scale_frequent = 0.9
model.topk_novel_boost = 1.35
model.topk_seen_scale = 0.95
model.score_floor_novel = 0.02
model.score_floor_seen = 0.0
model.per_class_nms = True
model.nms_iou_novel = 0.6
...
model.classifier.tpa_num_prototypes = 4  # reduce prototype collapse risk
