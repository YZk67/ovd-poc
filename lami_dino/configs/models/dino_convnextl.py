...
model = L(DINO)(
    ...
    unknown_iou_thr = 0.5,
    unknown_iou_thr_start = 0.3,
    unknown_warmup_iters = 2000,
    unknown_match_mode = "soft",
    unknown_match_cost = 2.0,
    pseudo_score_thr = 0.95,
    vlm_distill_enabled = False,
    vlm_distill_weight = 1.0,
    vlm_distill_temperature = 2.0,
