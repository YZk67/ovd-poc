...
# Eval config targets the official Real-LOD/Real-Model Swin-B D3 setup.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        choices=("text", "none"),
        default="text",
        help="'none' runs the DN-label-only control without text-query adapter.",
    )
...
def main() -> None:
    ...
    manifest: Dict[str, Any] = {
        "purpose": (
            "Route A adapter training: Real-LOD Real-Model on D3"
            if is_train
